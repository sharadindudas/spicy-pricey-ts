...
const RestaurantCard = (props: TopChainType) => {
    const {
        areaName,
        name,
        avgRating,
        ...
        <>
            {isOpen ? (
                <div className="flex flex-col gap-2 cursor-pointer">
                    <div className="w-80 h-56 relative rounded-xl">
                        <img
                    ...
                    <div className="ml-3">
                        ...
                        <p className="tracking-tight text-base text-gray-600">
                            {truncateString(cuisines?.join(", "), 33)}
                        </p>
                        <div className="tracking-tight text-base text-gray-600">
                            {areaName}
                        </div>
                    </div>
                </div>
