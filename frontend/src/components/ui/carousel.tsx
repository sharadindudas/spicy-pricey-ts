    ...
    return (
        <Button
            ...
            className={cn(
                ...
                orientation === "horizontal" ? "top-1/2 -translate-y-1/2" : "-top-12 -translate-x-1/2 rotate-90",
                className
            )}
...
function CarouselNext({ className, variant = "outline", size = "icon", ...props }: React.ComponentProps<typeof Button>) {
    ...
    return (
        <Button
            ...
            className={cn(
                "absolute h-8 w-8 rounded-full",
                orientation === "horizontal" ? "top-1/2 -translate-y-1/2" : "-bottom-12 -translate-x-1/2 rotate-90",
                className
            )}
