...
import ShimmerHome from "@/components/loader/ShimmerHome";
...
const Home = () => {
    const { isLoading, WhatsOnMind, TopChain, AllRestaurants, FilteredRestaurants, setFilteredRestaurants } = useGetRestaurants();
